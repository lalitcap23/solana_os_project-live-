...
| steel | Solana smart contract framework. | https://github.com/regolith-labs/steel | 234 | 7 | 2.1.0 (Oct 23, 2024) | SDKs & Tooling |
...
| solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 842 | 28 | Last commit (Sep 21, 2025) | SDKs & Tooling |
...
| star_frame | High performance, modular solana program framework | https://github.com/staratlasmeta/star_frame | 64 | 10 | v0.25.1 (Sep 11, 2025) | SDKs & Tooling |
...
| SPL Libraries (new org) | Helper libraries/building blocks for on-chain programs | https://github.com/solana-program/libraries | 10 | 21 | type-length-value@v0.9.0 (Aug 11, 2025) | Programs (SPL) |
...
| carbon | Carbon is an indexing framework on Solana. | https://github.com/sevenlabs-hq/carbon | 457 | 27 | v0.10.0 (Sep 16, 2025) | DeFi |
...
| Solana-Arbitrage-Trading-Bot | Atomic, fast, and pragmatic Solana arbitrage with Jito bundles, Jupiter (ULTRA/SWAP). | https://github.com/ApexArb/Solana-Arbitrage-Trading-Bot | 200 | 1 | Last commit (Sep 17, 2025) | DeFi |
