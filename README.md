...
| Solana SDK (Rust) | Rust SDK used by on-chain program developers and the Agave validator | https://github.com/anza-xyz/solana-sdk | 252 | 178 | signature@v3.5.1 (Aug 05, 2026) | SDKs & Tooling |
...
| program-examples | A repository of Solana program examples | https://github.com/solana-developers/program-examples | 1.4k | 65 | Last commit (Aug 05, 2026) | SDKs & Tooling |
...
| IDLGuesser | IDL Guesser is an open-source tool that automatically recovers the IDL information from closed-source Anchor-based Solana programs. | https://github.com/sec3-service/IDLGuesser | 163 | — | Last commit (Feb 18, 2026) | SDKs & Tooling |
...
| program-examples | A repository of Solana program examples | https://github.com/solana-foundation/program-examples | 1.4k | 65 | Last commit (Aug 05, 2026) | SDKs & Tooling |
...
| solana-pay-minimal-example | Solana Pay(@solana/pay) minimal examples and docs. | https://github.com/256hax/solana-pay-minimal-example | 2 | 1 | Last commit (Aug 31, 2023) | Payments |
