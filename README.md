...
| Anchor | Framework for building Solana programs (Rust eDSL, IDL, TS client, CLI) | https://github.com/coral-xyz/anchor | 4.5k | 302 | v0.31.1 (Apr 19, 2025) | SDKs & Tooling |
...
| 🆕 kit | Solana JavaScript SDK | https://github.com/anza-xyz/kit | 511 | 141 | v2.3.0 (Jul 09, 2025) | SDKs & Tooling |
| 🆕 js-wallet-sdk | Multi-chain typescript signature sdk, supports bitcoin, ethereum, solana, cosmos, etc. | https://github.com/okx/js-wallet-sdk | 329 | 11 | Last commit (May 23, 2025) | SDKs & Tooling |
| 🆕 program-examples | A repository of Solana program examples | https://github.com/solana-developers/program-examples | 1.2k | 45 | Last commit (Jul 23, 2025) | SDKs & Tooling |
| 🆕 Solana_Dice_SmartContract | This project is a simple on-chain Dice Game smart contract built for the Solana blockchain using Rust and the Anchor framework. It demonstrates the fundamentals of Solana program development, including instruction handling, randomness simulation, state management, and token transfers. | https://github.com/kinexbt/Solana_Dice_SmartContract | 681 | 1 | Last commit (May 08, 2025) | SDKs & Tooling |
| 🆕 Solana_Bita_Coinflip_SmartContract | A lightweight on-chain Coin Flip betting game built on the Solana blockchain using Rust and the Anchor framework. This contract allows users to wager SOL (or tokens) on a 50/50 coin flip outcome — win or lose instantly, with no intermediaries. | https://github.com/kinexbt/Solana_Bita_Coinflip_SmartContract | 675 | 1 | Last commit (May 07, 2025) | SDKs & Tooling |
| 🆕 complete-guide-to-full-stack-solana-development | Code examples for the blog post titled The Complete Guide to Full Stack Solana Development with React, Anchor, Rust, and Phantom | https://github.com/dabit3/complete-guide-to-full-stack-solana-development | 484 | 2 | Last commit (Sep 18, 2021) | SDKs & Tooling |
...
| 🆕 Solana-Prediction-Market | Solana Prediction Market where users can create market, add liquidity, and bet | https://github.com/HyperBuildX/Solana-Prediction-Market | 305 | 1 | Last commit (Jul 09, 2025) | SDKs & Tooling |
| 🆕 awesome-solana-security | A collection of resources to help you build better and more secure Solana programs. Kept up to date. | https://github.com/0xMacro/awesome-solana-security | 293 | 2 | Last commit (Jun 18, 2025) | SDKs & Tooling |
...
| 🆕 anchor-go | Generate Go clients from anchor IDLs for Solana blockchain programs | https://github.com/gagliardetto/anchor-go | 263 | 4 | v1.0.0 (Jul 02, 2025) | SDKs & Tooling |
| 🆕 solana-copy-bot | Copy any transaction at any address in Solana | https://github.com/Abraham-007/solana-copy-bot | 556 | 1 | Last commit (Aug 19, 2025) | SDKs & Tooling |
| 🆕 solana-trading-bot | Solana Trading Bot - RC: For Solana token sniping and trading, the latest version has completed all optimizations | https://github.com/warp-abbott/solana-trading-bot | 533 | 1 | Last commit (Aug 19, 2025) | SDKs & Tooling |
...
| 🆕 solana-spl-token-sniper | Solana SPL-Token sniper for new Raydium liquidity pools | https://github.com/danbayk/solana-spl-token-sniper | 191 | 1 | Last commit (Mar 19, 2024) | SDKs & Tooling |
...
| 🆕 solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 816 | 28 | Last commit (Aug 19, 2025) | SDKs & Tooling |
...
| 🆕 pumpfun-rs | A comprehensive Rust SDK for seamless interaction with the PumpFun Solana program. | https://github.com/nhuxhr/pumpfun-rs | 139 | 5 | Last commit (Aug 15, 2025) | SDKs & Tooling |
| 🆕 Solana-Auditors-Bootcamp | Learn to audit Solana programs and help secure the ecosystem. Take your security practices to the next level and get certified by Ackee Blockchain Security. It's free, too. | https://github.com/Ackee-Blockchain/Solana-Auditors-Bootcamp | 135 | 2 | Last commit (Sep 23, 2024) | SDKs & Tooling |
| 🆕 radar | A static analysis tool for anchor rust programs. | https://github.com/Auditware/radar | 101 | 3 | Last commit (Jul 03, 2025) | SDKs & Tooling |
...
| 🆕 Bonkfun-Bundler-Bonk.fun-Bundler | bonkfun bundler / bonk.fun bundler Letsbonk / Letsbonkfun bundler / Pump.fun bundler / pumpfun bundler / pumpdotfun bundler / bagsfm bundler/ bags.fm bundler trading bot. Multi-wallet bundler for Solana token launches. Uses Jito and Raydium SDK v2 for atomic one-block execution. | https://github.com/Tru3Bliss/Bonkfun-Bundler-Bonk.fun-Bundler | 203 | 1 | Last commit (Jul 23, 2025) | Wallets & Mobile |
...
| 🆕 crypto-trading-bot-mobile |  A cross-platform mobile crypto trading bot for Solana, built with Expo + React Native. Connect your Phantom Wallet, monitor coins, and automate trades in real time | https://github.com/0xTan1319/crypto-trading-bot-mobile | 34 | 1 | Last commit (Aug 07, 2025) | Wallets & Mobile |
...
| 🆕 gill | Solana JavaScript/TypeScript SDK - client library for interacting with the Solana blockchain | https://github.com/DecalLabs/gill | 312 | 17 | Last commit (Aug 12, 2025) | NFTs & Programs |
...
| 🆕 anchorpy | The Python Anchor client. | https://github.com/kevinheavey/anchorpy | 271 | 11 | 0.21.0 (Mar 26, 2025) | NFTs & Programs |
...
| 🆕 metaboss | The Metaplex NFT-standard Swiss Army Knife tool. | https://github.com/samuelvanderwaal/metaboss | 714 | 25 | v0.44.0 (Jan 08, 2025) | NFTs & Programs |
| 🆕 metaplex-program-library | Smart contracts maintained by the Metaplex team | https://github.com/metaplex-foundation/metaplex-program-library | 634 | 63 | Last commit (Nov 01, 2024) | NFTs & Programs |
...
| 🆕 shank | Extracts IDL from Solana Rust contracts | https://github.com/metaplex-foundation/shank | 186 | 7 | Last commit (Aug 12, 2025) | NFTs & Programs |
...
| 🆕 fetch-nft | 🖼🎑🌠 A utility to fetch and easily display Ethereum & Solana NFTs in a common format given any wallet | https://github.com/AudiusProject/fetch-nft | 121 | 7 | Last commit (Jan 13, 2025) | NFTs & Programs |
...
| 🆕 create-solana-dapp | The fastest way to create Solana apps 🚀 Templates 👉 https://github.com/solana-foundation/templates | https://github.com/solana-foundation/create-solana-dapp | 517 | 13 | Last commit (Aug 06, 2025) | NFTs & Programs |
...
| Jupiter Swap API | Jupiter V6 Swap API binaries and releases | https://github.com/jup-ag/jupiter-swap-api | 206 | 2 | v6.0.62 (Aug 18, 2025) | DeFi |
| 🆕 carbon | Carbon is an indexing framework on Solana. | https://github.com/sevenlabs-hq/carbon | 426 | 27 | v0.9.1 (Jul 18, 2025) | DeFi |
| 🆕 raydium-sdk-swap-example-typescript | An example to swap tokens on Solana using the Raydium SDK, TypeScript, and Chainstack | https://github.com/chainstacklabs/raydium-sdk-swap-example-typescript | 182 | 4 | Last commit (Jan 07, 2025) | DeFi |
| 🆕 Solana-Arbitrage-Bot-Flash-Loan | Solana Arbitrage Bot cross dex like Raydium, Orca, Meteora swap program with rust language architecture using anchor frame work | https://github.com/deniyuda348/Solana-Arbitrage-Bot-Flash-Loan | 328 | 3 | Solana-Arbitrage-Bot (May 20, 2025) | DeFi |
| 🆕 solana-txn-parser | An open-source transaction parser for popular DeFi applications on the Solana blockchain 🚀🤖.. | https://github.com/Tee-py/solana-txn-parser | 187 | 2 | v0.1.6 (Jul 18, 2025) | DeFi |
...
| 🆕 Solana-Arbitrage-Bot | Solana Arbitrage Bot cross dex like Raydium, Orca, Meteora swap program with rust language architecture using anchor frame work | https://github.com/ChangeYourself0613/Solana-Arbitrage-Bot | 237 | 1 | solana-arbitrage-bot2 (May 26, 2025) | DeFi |
| 🆕 sol-trade-sdk | A comprehensive Rust SDK for seamless interaction with Solana DEX trading programs. This SDK provides a robust set of tools and interfaces to integrate PumpFun, PumpSwap, Bonk, and Raydium CPMM functionality into your applications. | https://github.com/0xfnzero/sol-trade-sdk | 125 | 5 | Last commit (Aug 20, 2025) | DeFi |
