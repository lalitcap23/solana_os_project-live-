...
| Solana SDK (Rust) | Rust SDK used by on-chain program developers and the Agave validator | https://github.com/anza-xyz/solana-sdk | 215 | 168 | file-download@v3.1.3 (Mar 03, 2026) | SDKs & Tooling |
...
| kit | Solana JavaScript SDK | https://github.com/anza-xyz/kit | 666 | 158 | v6.1.0 (Feb 16, 2026) | SDKs & Tooling |
...
| Solana-Prediction-Market | Solana Prediction Market where users can create market, add liquidity, and bet | https://github.com/HyperBuildX/Solana-Prediction-Market | 351 | 2 | Last commit (Mar 04, 2026) | SDKs & Tooling |
| awesome-solana-security | A collection of resources to help you build better and more secure Solana programs. Kept up to date. | https://github.com/0xMacro/awesome-solana-security | 573 | 2 | Last commit (Dec 06, 2025) | SDKs & Tooling |
| Pumpfun-solana-smart-contract | pump.fun clone: pumpfun smart contract fork (pump.fun fork), solana pump fun smart contract source code | https://github.com/cutupdev/Pumpfun-solana-smart-contract | 383 | 1 | Last commit (Dec 21, 2025) | SDKs & Tooling |
...
| solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 925 | 31 | Last commit (Mar 04, 2026) | SDKs & Tooling |
...
| radar | A static analysis tool for anchor rust programs. | https://github.com/Auditware/radar | 134 | 5 | Last commit (Feb 21, 2026) | SDKs & Tooling |
...
| pumpfun-smart-contract-frontend-backend | Solana Pumpfun smart contract & Frontend & Backend | https://github.com/0xalberto/pumpfun-smart-contract-frontend-backend | 152 | 2 | Last commit (Mar 01, 2026) | SDKs & Tooling |
...
| Prediction-Market-Smart-Contract-Solana | A decentralized prediction market platform built on Solana, inspired by Polymarket. This project lets users create prediction markets, trade in prediction markets, and settle outcomes based on real events in a growing prediction market ecosystem. Built for Solana, EVM, Monad, Sui, Abstraqt, Ronin. | https://github.com/Tru3Bliss/Prediction-Market-Smart-Contract-Solana | 220 | 1 | Last commit (Feb 25, 2026) | SDKs & Tooling |
| EVM-Solana-Casino-Games | Blockchain Web3 Solana Casino Game | 🌐Multi-Chain Casino Platform | EVM + Sui |  10 Provably Fair Games | ORAO + Chainlink VRF |  Crash, Plinko, Dice, Blackjack, Roulette, Poker, Hi-Lo, Limbo, Coinflip. Contact for solana casino game building and solana casino game customization evm solana evm solana evm solana evm solana evm solana evm solana | https://github.com/LaChance-Lab/EVM-Solana-Casino-Games | 307 | 1 | Last commit (Feb 22, 2026) | SDKs & Tooling |
...
| Web3-EVM-Solana-Casino-Games | Blockchain Web3 Solana Casino Game | 🌐Multi-Chain Casino Platform | EVM + Sui |  10 Provably Fair Games | ORAO + Chainlink VRF |  Crash, Plinko, Dice, Blackjack, Roulette, Poker, Hi-Lo, Limbo, Coinflip. Contact for solana casino game building and solana casino game customization evm solana evm solana evm solana evm solana evm solana evm solana | https://github.com/LaChance-Lab/Web3-EVM-Solana-Casino-Games | 307 | 1 | Last commit (Feb 22, 2026) | SDKs & Tooling |
...
| anchor-client-gen | A tool for generating solana web3 clients from anchor IDLs. | https://github.com/kklas/anchor-client-gen | 208 | 8 | Last commit (Feb 24, 2026) | SDKs & Tooling |
| solana-trading-bot | solana bot || solana trading bot || solana warp trading bot || solana meme sniper bot || solana trade bot || solana trading bot v3 || solana raydium sniper bot 3.0.0 | https://github.com/warp-specke/solana-trading-bot | 695 | 1 | Last commit (Feb 28, 2026) | SDKs & Tooling |
| solana-pumpfun-sniper-bot | solana bot, solana trading bot, solana pumpfun bot, solana pumpfun sniper bot, solana pumpfun raydium bot, solana pumpfun raydium sniper bot | https://github.com/HaiderFlorez/solana-pumpfun-sniper-bot | 692 | 1 | Last commit (Mar 01, 2026) | SDKs & Tooling |
| solana-trading-bot | solana bot || solana trading bot || solana warp trading bot || solana meme sniper bot || solana trade bot || solana trading bot v3 || solana raydium sniper bot | https://github.com/channeleldernumber/solana-trading-bot | 71 | 1 | Last commit (Feb 27, 2026) | SDKs & Tooling |
...
| espresso-cash-public | Dart and Flutter apps and libraries maintained by Espresso Cash team for Solana. | https://github.com/espresso-cash/espresso-cash-public | 303 | 24 | Last commit (Jan 02, 2026) | Wallets & Mobile |
...
| espresso-cash-public | Dart and Flutter apps and libraries maintained by Espresso Cash team for Solana. | https://github.com/brij-digital/espresso-cash-public | 303 | 24 | Last commit (Jan 02, 2026) | Wallets & Mobile |
...
| gill | Solana JavaScript/TypeScript SDK - client library for interacting with the Solana blockchain | https://github.com/DecalLabs/gill | 415 | 26 | Last commit (Nov 16, 2025) | NFTs & Programs |
...
| create-solana-dapp | The fastest way to create Solana apps 🚀 Templates 👉 https://github.com/solana-foundation/templates | https://github.com/solana-foundation/create-solana-dapp | 613 | 17 | Last commit (Jan 08, 2026) | NFTs & Programs |
...
| gill | Solana JavaScript/TypeScript SDK - client library for interacting with the Solana blockchain | https://github.com/gillsdk/gill | 415 | 26 | Last commit (Nov 16, 2025) | NFTs & Programs |
...
| solana-casino-smart-contract | A Solana casino smart contract is a blockchain program that safely holds player money, runs casino rules fairly, and automatically pays winnings without trusting a central server. | https://github.com/FroganBee/solana-casino-smart-contract | 91 | 1 | Last commit (Jan 30, 2026) | Payments |
| solana-casino-smart-contract | A Solana casino smart contract is a blockchain program that safely holds player money, runs casino rules fairly, and automatically pays winnings without trusting a central server. | https://github.com/Solzen33/solana-casino-smart-contract | 91 | 1 | Last commit (Jan 30, 2026) | Payments |
| Jupiter Swap API | Jupiter V6 Swap API binaries and releases | https://github.com/jup-ag/jupiter-swap-api | 242 | 3 | v7.0.8 (Mar 03, 2026) | DeFi |
| carbon | Carbon is an indexing framework on Solana. | https://github.com/sevenlabs-hq/carbon | 557 | 39 | v0.12.0 (Nov 27, 2025) | DeFi |
...
| Solana-Arbitrage-Trading-Bot | Atomic, fast, and pragmatic Solana arbitrage with Jito bundles, Jupiter (ULTRA/SWAP). | https://github.com/ApexArb/Solana-Arbitrage-Trading-Bot | 62 | 1 | Last commit (Sep 17, 2025) | DeFi |
| Four.meme-Pump.fun-Fork-Fourmeme-Pumpfun | Multichain Web3 Framework — supports Pump.fun (Solana), Four.meme (BNB), and Xpad.fun (EVM) with smart contracts, backend, and frontend integrations. Compatible with Raydium, Meteora, Pumpswap, and Uniswap on Solana & EVM (Monad, BNB, Ethereum L1/L2). | https://github.com/Tru3Bliss/Four.meme-Pump.fun-Fork-Fourmeme-Pumpfun | 196 | 1 | Last commit (Feb 22, 2026) | DeFi |
