...
| Agave (validator) | Current Solana validator implementation maintained by Anza | https://github.com/anza-xyz/agave | 1.5k | 363 | v2.3.13 (Oct 10, 2025) | Infrastructure |
| Solana SDK (Rust) | Rust SDK used by on-chain program developers and the Agave validator | https://github.com/anza-xyz/solana-sdk | 152 | 152 | vote-interface@v4.0.4 (Oct 17, 2025) | SDKs & Tooling |
...
| trident | Rust-based framework to Fuzz Solana programs, designed to help you ship secure code. | https://github.com/Ackee-Blockchain/trident | 331 | 20 | 0.11.1 (Oct 21, 2025) | SDKs & Tooling |
...
| kit | Solana JavaScript SDK | https://github.com/anza-xyz/kit | 571 | 147 | v4.0.0 (Oct 08, 2025) | SDKs & Tooling |
| js-wallet-sdk | Multi-chain typescript signature sdk, supports bitcoin, ethereum, solana, cosmos, etc. | https://github.com/okx/js-wallet-sdk | 360 | 13 | Last commit (Oct 09, 2025) | SDKs & Tooling |
...
| Pumpfun-solana-smart-contract | pump.fun clone: pumpfun smart contract fork (pump.fun fork), solana pump fun smart contract source code | https://github.com/cutupdev/Pumpfun-solana-smart-contract | 325 | 1 | Last commit (Jun 30, 2025) | SDKs & Tooling |
...
| solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 866 | 28 | Last commit (Oct 21, 2025) | SDKs & Tooling |
...
| radar | A static analysis tool for anchor rust programs. | https://github.com/Auditware/radar | 109 | 4 | Last commit (Oct 21, 2025) | SDKs & Tooling |
...
| solana-sign-with-payment | Prove ownership of a Solana address by asking the user to send a small amount | https://github.com/kizzx2/solana-sign-with-payment | — | — | Active | SDKs & Tooling |
...
| star_frame | High performance, modular solana program framework | https://github.com/staratlasmeta/star_frame | 69 | 11 | v0.26.2 (Oct 15, 2025) | SDKs & Tooling |
...
| Solana Mobile Stack SDK | Android SDKs: Mobile Wallet Adapter, Seed Vault | https://github.com/solana-mobile/solana-mobile-stack-sdk | 767 | 2 | Last commit (Jun 23, 2022) | Wallets & Mobile |
...
| gill | Solana JavaScript/TypeScript SDK - client library for interacting with the Solana blockchain | https://github.com/DecalLabs/gill | 357 | 23 | Last commit (Oct 03, 2025) | NFTs & Programs |
...
| metaplex-program-library | Smart contracts maintained by the Metaplex team | https://github.com/metaplex-foundation/metaplex-program-library | 639 | 64 | Last commit (Oct 02, 2025) | NFTs & Programs |
...
| digital-asset-rpc-infrastructure | Reference implementation for Metaplex Digital Asset Standard API | https://github.com/metaplex-foundation/digital-asset-rpc-infrastructure | 111 | 18 | v0.6.8 (Feb 22, 2023) | NFTs & Programs |
...
| create-solana-dapp | The fastest way to create Solana apps 🚀 Templates 👉 https://github.com/solana-foundation/templates | https://github.com/solana-foundation/create-solana-dapp | 553 | 14 | Last commit (Sep 19, 2025) | NFTs & Programs |
...
| gill | Solana JavaScript/TypeScript SDK - client library for interacting with the Solana blockchain | https://github.com/gillsdk/gill | 357 | 23 | Last commit (Oct 03, 2025) | NFTs & Programs |
...
| carbon | Carbon is an indexing framework on Solana. | https://github.com/sevenlabs-hq/carbon | 482 | 31 | v0.11.0 (Oct 18, 2025) | DeFi |
...
| pirate-bootcamp | A pirate-theme bootcamp for getting up to speed on Solana programming! | https://github.com/solana-developers/pirate-bootcamp | 322 | 4 | Last commit (Sep 05, 2023) | DeFi |
...
| Solana-Memecoin-CLI | Solana Memecoin CLI is a powerful tool designed for volume booster and this is a copy bot for trading dev integrated with Jito bundles, Jupiter, Raydium, and Pump.fun | https://github.com/earthskyorg/Solana-Memecoin-CLI | 38 | 1 | Last commit (Feb 20, 2025) | DeFi |
