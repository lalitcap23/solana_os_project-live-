...
| Solana SDK (Rust) | Rust SDK used by on-chain program developers and the Agave validator | https://github.com/anza-xyz/solana-sdk | 227 | 170 | wincode-varint@v1.0.0 (Apr 08, 2026) | SDKs & Tooling |
...
| kit | Solana JavaScript SDK | https://github.com/anza-xyz/kit | 673 | 163 | v6.7.0 (Apr 02, 2026) | SDKs & Tooling |
...
| solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 928 | 31 | Last commit (Apr 09, 2026) | SDKs & Tooling |
| anchor-escrow | Escrow program implemented in Anchor | https://github.com/ironaddicteddog/anchor-escrow | 196 | 3 | Last commit (Aug 29, 2024) | SDKs & Tooling |
...
| quasar | A blazing fast Solana program framework. | https://github.com/blueshift-gg/quasar | 113 | 8 | Last commit (Apr 09, 2026) | SDKs & Tooling |
| Pumpfun-Solana-Smart-Contract | pump.fun clone: pumpfun smart contract fork (pump.fun fork), solana pump fun smart contract source code | https://github.com/cutupdev/Pumpfun-Solana-Smart-Contract | 334 | 1 | Last commit (Dec 21, 2025) | SDKs & Tooling |
...
| espresso-cash-public | Dart and Flutter apps and libraries maintained by Espresso Cash team for Solana. | https://github.com/espresso-cash/espresso-cash-public | 302 | 24 | Last commit (Jan 02, 2026) | Wallets & Mobile |
...
| create-solana-dapp | The fastest way to create Solana apps 🚀 Templates 👉 https://github.com/solana-foundation/templates | https://github.com/solana-foundation/create-solana-dapp | 619 | 19 | Last commit (Mar 16, 2026) | NFTs & Programs |
...
| Jupiter Swap API | Jupiter V6 Swap API binaries and releases | https://github.com/jup-ag/jupiter-swap-api | 244 | 3 | v7.0.9 (Mar 27, 2026) | DeFi |
