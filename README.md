...
| Solana SDK (Rust) | Rust SDK used by on-chain program developers and the Agave validator | https://github.com/anza-xyz/solana-sdk | 238 | 173 | instructions-sysvar@v3.0.1 (May 20, 2026) | SDKs & Tooling |
| Anchor | Framework for building Solana programs (Rust eDSL, IDL, TS client, CLI) | https://github.com/coral-xyz/anchor | 5.1k | 339 | v1.0.2 (May 02, 2026) | SDKs & Tooling |
...
| anchor | ⚓ Solana Sealevel Framework | https://github.com/solana-foundation/anchor | 5.1k | 339 | v1.0.2 (May 02, 2026) | SDKs & Tooling |
...
| kit | Solana JavaScript SDK | https://github.com/anza-xyz/kit | 683 | 164 | v6.9.0 (May 06, 2026) | SDKs & Tooling |
...
| solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 937 | 32 | Last commit (May 19, 2026) | SDKs & Tooling |
...
| quasar | A blazing fast Solana program framework. | https://github.com/blueshift-gg/quasar | 153 | 18 | Last commit (May 18, 2026) | SDKs & Tooling |
| Pumpfun-Solana-Smart-Contract | pump.fun clone: pumpfun smart contract fork (pump.fun fork), solana pump fun smart contract source code | https://github.com/cutupdev/Pumpfun-Solana-Smart-Contract | 313 | 1 | Last commit (Dec 21, 2025) | SDKs & Tooling |
...
| anchor | ⚓ Solana Program Framework | https://github.com/otter-sec/anchor | 5.1k | 339 | v1.0.2 (May 02, 2026) | SDKs & Tooling |
...
| mobile_app | Offline-first Solana wallet and encrypted mesh messenger. over BLE · LoRa · TCP. No internet. No SIM. Powered by Arcium + Reticulum. | https://github.com/anonmesh/mobile_app | 16 | 2 | v1.0.2 (May 15, 2026) | Wallets & Mobile |
| NEW solana-wallet-pnl-profit-and-loss-api | Solana Wallet PnL API: This repo demonstrates how to use Vybe Solana wallet PnL APIs to fetch, filter, and analyze per-wallet profit and loss (PnL), related wallets, trades, and SPL/Token-2022 token metadata. Use it as a reference or starter kit for analytics dashboards, PnL leaderboards, related-wallet discovery, and similar data products. | https://github.com/vybenetwork/solana-wallet-pnl-profit-and-loss-api | 127 | 1 | Last commit (May 19, 2026) | Wallets & Mobile |
...
| Candy Machine (Core) | Metaplex Core Candy Machine (Core assets) | https://github.com/metaplex-foundation/mpl-core-candy-machine | 36 | 5 | js@v0.3.0 (Jan 27, 2025) | NFTs & Minting |
...
| solana-trading-cli | Trading infrastructure for AI agents and Humans on Solana. 17 DEX adapters, 12 TX landing providers, LP operations, and a unified CLI/SDK — with gRPC streaming and OpenClaw agent integration coming next. | https://github.com/outsmartchad/solana-trading-cli | 576 | 6 | v0.1.2 (Apr 11, 2025) | DeFi |
...
| cryptocurrency.cv | Free crypto news API - real-time aggregator for Bitcoin, Ethereum, DeFi, Solana & altcoins. No API key required. RSS/Atom feeds, JSON REST API, historical archive with market context, embeddable widgets, ChatGPT plugin, Claude MCP server, SDKs (Python, TypeScript, Go, React, PHP). AI/LLM ready. Vibe coding friendly. Open source. | https://github.com/nirholas/cryptocurrency.cv | 211 | 10 | Last commit (May 13, 2026) | DeFi |
...
| teller-solana-dapp | Solana wallet analytics and chain stats dApp adapted for Solana Mobile and dApp Store | https://github.com/NadirAliOfficial/teller-solana-dapp | 6 | 1 | v2026.05.20 (May 20, 2026) | DeFi |
