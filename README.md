...
| Solana-Prediction-Market | Solana Prediction Market where users can create market, add liquidity, and bet | https://github.com/HyperBuildX/Solana-Prediction-Market | 335 | 1 | Last commit (Feb 22, 2026) | SDKs & Tooling |
...
| solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 919 | 30 | Last commit (Feb 22, 2026) | SDKs & Tooling |
...
| radar | A static analysis tool for anchor rust programs. | https://github.com/Auditware/radar | 128 | 5 | Last commit (Feb 21, 2026) | SDKs & Tooling |
...
| solana-starter-kit | Open-source Solana dApp template with Anchor program, TypeScript client, and Next.js UI. | https://github.com/SolanaUpdateTools/solana-starter-kit | 343 | 1 | Last commit (Nov 06, 2025) | SDKs & Tooling |
...
| NEW anchor-client-gen | A tool for generating solana web3 clients from anchor IDLs. | https://github.com/kklas/anchor-client-gen | 206 | 7 | Last commit (Oct 29, 2025) | SDKs & Tooling |
