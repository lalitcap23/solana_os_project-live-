...
| Solana SDK (Rust) | Rust SDK used by on-chain program developers and the Agave validator | https://github.com/anza-xyz/solana-sdk | 250 | 175 | transaction@v4.1.5 (Jun 30, 2026) | SDKs & Tooling |
...
| Bita_Contract | A lightweight on-chain Coin Flip betting game built on the Solana blockchain using Rust and the Anchor framework. This contract allows users to wager SOL (or tokens) on a 50/50 coin flip outcome — win or lose instantly, with no intermediaries. | https://github.com/kinexbt/Bita_Contract | 17 | 1 | Last commit (Jun 30, 2026) | SDKs & Tooling |
...
| Croptopia | Building Croptopia — a multiplayer farming protocol on Solana. 100 plots, four tiers, finite supply. Anchor program at /Croptopia. | https://github.com/playCroptopia/Croptopia | 625 | 1 | Last commit (Jul 01, 2026) | SDKs & Tooling |
