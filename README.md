...
| Solana SDK (Rust) | Rust SDK used by on-chain program developers and the Agave validator | https://github.com/anza-xyz/solana-sdk | 153 | 152 | frozen-abi@v3.0.1 (Oct 23, 2025) | SDKs & Tooling |
...
| trident | Rust-based framework to Fuzz Solana programs, designed to help you ship secure code. | https://github.com/Ackee-Blockchain/trident | 333 | 20 | 0.11.1 (Oct 21, 2025) | SDKs & Tooling |
...
| kit | Solana JavaScript SDK | https://github.com/anza-xyz/kit | 572 | 147 | v5.0.0 (Oct 23, 2025) | SDKs & Tooling |
| js-wallet-sdk | Multi-chain typescript signature sdk, supports bitcoin, ethereum, solana, cosmos, etc. | https://github.com/okx/js-wallet-sdk | 362 | 13 | Last commit (Oct 09, 2025) | SDKs & Tooling |
...
| Pumpfun-solana-smart-contract | pump.fun clone: pumpfun smart contract fork (pump.fun fork), solana pump fun smart contract source code | https://github.com/cutupdev/Pumpfun-solana-smart-contract | 340 | 1 | Last commit (Jun 30, 2025) | SDKs & Tooling |
...
| espresso-cash-public | Dart and Flutter apps and libraries maintained by Espresso Cash team for Solana. | https://github.com/espresso-cash/espresso-cash-public | 304 | 24 | Last commit (Aug 03, 2025) | Wallets & Mobile |
...
| gill | Solana JavaScript/TypeScript SDK - client library for interacting with the Solana blockchain | https://github.com/DecalLabs/gill | 362 | 24 | Last commit (Oct 24, 2025) | NFTs & Programs |
...
| anchorpy | The Python Anchor client. | https://github.com/kevinheavey/anchorpy | 274 | 11 | 0.21.0 (Mar 26, 2025) | NFTs & Programs |
...
| create-solana-dapp | The fastest way to create Solana apps 🚀 Templates 👉 https://github.com/solana-foundation/templates | https://github.com/solana-foundation/create-solana-dapp | 556 | 15 | Last commit (Oct 24, 2025) | NFTs & Programs |
...
| gill | Solana JavaScript/TypeScript SDK - client library for interacting with the Solana blockchain | https://github.com/gillsdk/gill | 362 | 24 | Last commit (Oct 24, 2025) | NFTs & Programs |
