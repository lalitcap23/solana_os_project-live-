...
| solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 886 | 28 | Last commit (Nov 25, 2025) | SDKs & Tooling |
...
| solana-starter-kit | Open-source Solana dApp template with Anchor program, TypeScript client, and Next.js UI. | https://github.com/SolanaUpdateTools/solana-starter-kit | 400 | 1 | Last commit (Nov 06, 2025) | SDKs & Tooling |
...
| carbon | Carbon is an indexing framework on Solana. | https://github.com/sevenlabs-hq/carbon | 503 | 35 | v0.11.0 (Oct 18, 2025) | DeFi |
