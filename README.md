...
| solana-poker-casino-game | A Solana Poker Casino Game is an online casino-style poker game built on the Solana blockchain, where players use crypto (like SOL or SPL tokens) instead of fiat money. | https://github.com/0xRustPro/solana-poker-casino-game | 34 | 1 | Last commit (Dec 14, 2025) | SDKs & Tooling |
...
| solana-trading-bot | solana bot || solana trading bot || solana warp trading bot || solana meme sniper bot || solana trade bot || solana trading bot v3 || solana raydium sniper bot 3.0.0 | https://github.com/warp-specke/solana-trading-bot | 667 | 1 | Last commit (Apr 01, 2026) | SDKs & Tooling |
...
| solana-trading-bot | solana bot || solana trading bot || solana warp trading bot || solana meme sniper bot || solana trade bot || solana trading bot v3 || solana raydium sniper bot | https://github.com/channeleldernumber/solana-trading-bot | 5 | 1 | Last commit (Feb 27, 2026) | SDKs & Tooling |
...
| quasar | A blazing fast Solana program framework. | https://github.com/blueshift-gg/quasar | 97 | 8 | Last commit (Mar 30, 2026) | SDKs & Tooling |
| Pumpfun-Solana-Smart-Contract | pump.fun clone: pumpfun smart contract fork (pump.fun fork), solana pump fun smart contract source code | https://github.com/cutupdev/Pumpfun-Solana-Smart-Contract | 334 | 1 | Last commit (Dec 21, 2025) | SDKs & Tooling |
