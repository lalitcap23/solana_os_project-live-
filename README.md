...
| Solders (Python) | High-performance Python toolkit for Solana (Rust-backed) | https://github.com/kevinheavey/solders | 436 | 12 | v0.27.1 (Nov 15, 2025) | SDKs & Tooling |
...
| kit | Solana JavaScript SDK | https://github.com/anza-xyz/kit | 669 | 159 | v6.2.0 (Mar 09, 2026) | SDKs & Tooling |
...
| Solana-Prediction-Market | Solana Prediction Market where users can create market, add liquidity, and bet | https://github.com/HyperBuildX/Solana-Prediction-Market | 362 | 2 | Last commit (Mar 04, 2026) | SDKs & Tooling |
| awesome-solana-security | A collection of resources to help you build better and more secure Solana programs. Kept up to date. | https://github.com/0xMacro/awesome-solana-security | 578 | 2 | Last commit (Dec 06, 2025) | SDKs & Tooling |
...
| create-solana-dapp | The fastest way to create Solana apps 🚀 Templates 👉 https://github.com/solana-foundation/templates | https://github.com/solana-foundation/create-solana-dapp | 611 | 18 | Last commit (Mar 11, 2026) | NFTs & Programs |
...
| carbon | Carbon is an indexing framework on Solana. | https://github.com/sevenlabs-hq/carbon | 559 | 39 | v0.12.0 (Nov 27, 2025) | DeFi |
