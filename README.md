...
| kit | Solana JavaScript SDK | https://github.com/anza-xyz/kit | 675 | 162 | v6.5.0 (Mar 19, 2026) | SDKs & Tooling |
...
| solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 929 | 31 | Last commit (Mar 31, 2026) | SDKs & Tooling |
...
| pumpfun-smart-contract-frontend-backend | Solana Pumpfun smart contract & Frontend & Backend | https://github.com/0xalberto/pumpfun-smart-contract-frontend-backend | 158 | 1 | Last commit (Mar 23, 2026) | SDKs & Tooling |
...
| solana-trading-bot | solana bot || solana trading bot || solana warp trading bot || solana meme sniper bot || solana trade bot || solana trading bot v3 || solana raydium sniper bot 3.0.0 | https://github.com/warp-specke/solana-trading-bot | 669 | 1 | Last commit (Mar 31, 2026) | SDKs & Tooling |
...
| quasar | A blazing fast Solana program framework. | https://github.com/blueshift-gg/quasar | 96 | 8 | Last commit (Mar 30, 2026) | SDKs & Tooling |
| Pumpfun-Solana-Smart-Contract | pump.fun clone: pumpfun smart contract fork (pump.fun fork), solana pump fun smart contract source code | https://github.com/cutupdev/Pumpfun-Solana-Smart-Contract | 352 | 1 | Last commit (Dec 21, 2025) | SDKs & Tooling |
...
| solanaArtGuard-AI-nft-marketplace | AI-driven NFT validation system designed to verify the authenticity and originality of artworks minted on the Solana blockchain. | https://github.com/machenxi/solanaArtGuard-AI-nft-marketplace | 150 | 1 | Last commit (Aug 02, 2023) | NFTs & Programs |
