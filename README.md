...
| Solana SDK (Rust) | Rust SDK used by on-chain program developers and the Agave validator | https://github.com/anza-xyz/solana-sdk | 171 | 159 | rent@v3.1.0 (Dec 05, 2025) | SDKs & Tooling |
...
| awesome-solana-security | A collection of resources to help you build better and more secure Solana programs. Kept up to date. | https://github.com/0xMacro/awesome-solana-security | 452 | 2 | Last commit (Dec 06, 2025) | SDKs & Tooling |
...
| create-solana-dapp | The fastest way to create Solana apps 🚀 Templates 👉 https://github.com/solana-foundation/templates | https://github.com/solana-foundation/create-solana-dapp | 582 | 16 | Last commit (Dec 02, 2025) | NFTs & Programs |
