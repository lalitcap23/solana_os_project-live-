...
| kit | Solana JavaScript SDK | https://github.com/anza-xyz/kit | 537 | 143 | v3.0.3 (Sep 11, 2025) | SDKs & Tooling |
...
| pumpfun-sdk | A comprehensive Rust SDK for seamless interaction with the PumpFun Solana program. This SDK provides a robust set of tools and interfaces to integrate PumpFun functionality into your applications.  Resources | https://github.com/0xfnzero/pumpfun-sdk | 65 | 2 | Last commit (Sep 13, 2025) | SDKs & Tooling |
| IDLGuesser | IDL Guesser is an open-source tool that automatically recovers the IDL information from closed-source Anchor-based Solana programs. | https://github.com/sec3-service/IDLGuesser | 139 | 2 | Last commit (Aug 12, 2025) | SDKs & Tooling |
