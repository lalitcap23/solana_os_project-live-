...
| kit | Solana JavaScript SDK | https://github.com/anza-xyz/kit | 513 | 141 | v2.3.0 (Jul 09, 2025) | SDKs & Tooling |
...
| awesome-solana-security | A collection of resources to help you build better and more secure Solana programs. Kept up to date. | https://github.com/0xMacro/awesome-solana-security | 304 | 2 | Last commit (Jun 18, 2025) | SDKs & Tooling |
...
| solana-copy-bot | Copy any transaction at any address in Solana | https://github.com/Abraham-007/solana-copy-bot | 557 | 1 | Last commit (Aug 19, 2025) | SDKs & Tooling |
| solana-trading-bot | Solana Trading Bot - RC: For Solana token sniping and trading, the latest version has completed all optimizations | https://github.com/warp-abbott/solana-trading-bot | 535 | 1 | Last commit (Aug 19, 2025) | SDKs & Tooling |
...
| solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 815 | 28 | Last commit (Aug 22, 2025) | SDKs & Tooling |
...
| metaboss | The Metaplex NFT-standard Swiss Army Knife tool. | https://github.com/samuelvanderwaal/metaboss | 715 | 25 | v0.44.0 (Jan 08, 2025) | NFTs & Programs |
...
| Solana-Arbitrage-Bot | Solana Arbitrage Bot cross dex like Raydium, Orca, Meteora swap program with rust language architecture using anchor frame work | https://github.com/ChangeYourself0613/Solana-Arbitrage-Bot | 240 | 1 | solana-arbitrage-bot2 (May 26, 2025) | DeFi |
| sol-trade-sdk | A comprehensive Rust SDK for seamless interaction with Solana DEX trading programs. This SDK provides a robust set of tools and interfaces to integrate PumpFun, PumpSwap, Bonk, and Raydium CPMM functionality into your applications. | https://github.com/0xfnzero/sol-trade-sdk | 131 | 6 | Last commit (Aug 22, 2025) | DeFi |
