...
| Solana SDK (Rust) | Rust SDK used by on-chain program developers and the Agave validator | https://github.com/anza-xyz/solana-sdk | 170 | 159 | rent@v3.1.0 (Dec 05, 2025) | SDKs & Tooling |
...
| trident | Rust-based framework to Fuzz Solana programs, designed to help you ship secure code. | https://github.com/Ackee-Blockchain/trident | 342 | 20 | 0.12.0 (Nov 27, 2025) | SDKs & Tooling |
...
| steel | Solana smart contract framework. | https://github.com/regolith-labs/steel | 250 | 7 | 2.1.0 (Oct 23, 2024) | SDKs & Tooling |
...
| Solana-Prediction-Market | Solana Prediction Market where users can create market, add liquidity, and bet | https://github.com/HyperBuildX/Solana-Prediction-Market | 288 | 1 | Last commit (Oct 13, 2025) | SDKs & Tooling |
| awesome-solana-security | A collection of resources to help you build better and more secure Solana programs. Kept up to date. | https://github.com/0xMacro/awesome-solana-security | 450 | 2 | Last commit (Dec 06, 2025) | SDKs & Tooling |
| Pumpfun-solana-smart-contract | pump.fun clone: pumpfun smart contract fork (pump.fun fork), solana pump fun smart contract source code | https://github.com/cutupdev/Pumpfun-solana-smart-contract | 378 | 1 | Last commit (Jun 30, 2025) | SDKs & Tooling |
...
| solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 897 | 28 | Last commit (Dec 08, 2025) | SDKs & Tooling |
...
| pumpfun-rs | A comprehensive Rust SDK for seamless interaction with the PumpFun Solana program. | https://github.com/nhuxhr/pumpfun-rs | 154 | 5 | Last commit (Oct 01, 2025) | SDKs & Tooling |
...
| solana-trading-bot | Solana Trading Bot is an algorithmic trading bot designed to automate the trading process of Solana specific ecosystem tokens. | https://github.com/bytemagi/solana-trading-bot | 200 | 1 | Last commit (Feb 24, 2025) | SDKs & Tooling |
...
| solana-trading-bot | Solana Trading Bot is an algorithmic trading bot designed to automate the trading process of Solana specific ecosystem tokens. | https://github.com/ivorn42/solana-trading-bot | 200 | 1 | Last commit (Feb 24, 2025) | SDKs & Tooling |
...
| gill | Solana JavaScript/TypeScript SDK - client library for interacting with the Solana blockchain | https://github.com/DecalLabs/gill | 399 | 26 | Last commit (Nov 16, 2025) | NFTs & Programs |
...
| metaboss | The Metaplex NFT-standard Swiss Army Knife tool. | https://github.com/samuelvanderwaal/metaboss | 721 | 25 | v0.44.1 (Aug 25, 2025) | NFTs & Programs |
...
| shank | Extracts IDL from Solana Rust contracts | https://github.com/metaplex-foundation/shank | 206 | 7 | Last commit (Nov 26, 2025) | NFTs & Programs |
...
| create-solana-dapp | The fastest way to create Solana apps 🚀 Templates 👉 https://github.com/solana-foundation/templates | https://github.com/solana-foundation/create-solana-dapp | 581 | 16 | Last commit (Dec 02, 2025) | NFTs & Programs |
...
| gill | Solana JavaScript/TypeScript SDK - client library for interacting with the Solana blockchain | https://github.com/gillsdk/gill | 399 | 26 | Last commit (Nov 16, 2025) | NFTs & Programs |
...
| Jupiter Swap API | Jupiter V6 Swap API binaries and releases | https://github.com/jup-ag/jupiter-swap-api | 235 | 3 | v7.0.1 (Dec 02, 2025) | DeFi |
...
| Solana-Memecoin-CLI | Solana Memecoin CLI is a powerful tool designed for volume booster and this is a copy bot for trading dev integrated with Jito bundles, Jupiter, Raydium, and Pump.fun | https://github.com/earthskyorg/Solana-Memecoin-CLI | 40 | 1 | Last commit (Oct 22, 2025) | DeFi |
