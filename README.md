...
| trident | Rust-based framework to Fuzz Solana programs, designed to help you ship secure code. | https://github.com/Ackee-Blockchain/trident | 322 | 19 | 0.11.0 (Aug 14, 2025) | SDKs & Tooling |
...
| solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 847 | 28 | Last commit (Sep 27, 2025) | SDKs & Tooling |
...
| gill | Solana JavaScript/TypeScript SDK - client library for interacting with the Solana blockchain | https://github.com/DecalLabs/gill | 337 | 21 | Last commit (Sep 24, 2025) | NFTs & Programs |
...
| create-solana-dapp | The fastest way to create Solana apps 🚀 Templates 👉 https://github.com/solana-foundation/templates | https://github.com/solana-foundation/create-solana-dapp | 537 | 14 | Last commit (Sep 19, 2025) | NFTs & Programs |
...
| gill | Solana JavaScript/TypeScript SDK - client library for interacting with the Solana blockchain | https://github.com/gillsdk/gill | 337 | 21 | Last commit (Sep 24, 2025) | NFTs & Programs |
...
| pirate-bootcamp | A pirate-theme bootcamp for getting up to speed on Solana programming! | https://github.com/solana-developers/pirate-bootcamp | 318 | 4 | Last commit (Sep 05, 2023) | DeFi |
