...
| Solana SDK (Rust) | Rust SDK used by on-chain program developers and the Agave validator | https://github.com/anza-xyz/solana-sdk | 195 | 163 | bn254@v3.2.1 (Jan 14, 2026) | SDKs & Tooling |
...
| pumpfun-rs | A comprehensive Rust SDK for seamless interaction with the PumpFun Solana program. | https://github.com/nhuxhr/pumpfun-rs | 160 | 5 | Last commit (Oct 01, 2025) | SDKs & Tooling |
...
| star_frame | High performance, modular solana program framework | https://github.com/staratlasmeta/star_frame | 77 | 12 | v0.28.0 (Jan 09, 2026) | SDKs & Tooling |
...
| typhoon | 🌪️ Solana Sealevel Framework | https://github.com/exotic-markets-labs/typhoon | 64 | 7 | Last commit (Jan 26, 2026) | SDKs & Tooling |
...
| solana-starter-kit | Open-source Solana dApp template with Anchor program, TypeScript client, and Next.js UI. | https://github.com/SolanaUpdateTools/solana-starter-kit | 358 | 1 | Last commit (Nov 06, 2025) | SDKs & Tooling |
...
| solana-pumpfun-sniper-bot | solana bot || solana pumpfun bot || solana pumpfun sniper bot || solana pumpfun trading bot | https://github.com/ahmedrabby13/solana-pumpfun-sniper-bot | 592 | 1 | Last commit (Jan 26, 2026) | SDKs & Tooling |
