...
| Solana SDK (Rust) | Rust SDK used by on-chain program developers and the Agave validator | https://github.com/anza-xyz/solana-sdk | 228 | 170 | frozen-abi@v3.3.0 (Apr 13, 2026) | SDKs & Tooling |
| Anchor | Framework for building Solana programs (Rust eDSL, IDL, TS client, CLI) | https://github.com/coral-xyz/anchor | 5.0k | 318 | v1.0.0 (Apr 02, 2026) | SDKs & Tooling |
...
| anchor | ⚓ Solana Sealevel Framework | https://github.com/solana-foundation/anchor | 5.0k | 318 | v1.0.0 (Apr 02, 2026) | SDKs & Tooling |
...
| program-examples | A repository of Solana program examples | https://github.com/solana-developers/program-examples | 1.4k | 51 | Last commit (Apr 13, 2026) | SDKs & Tooling |
...
| awesome-solana-security | A collection of resources to help you build better and more secure Solana programs. Kept up to date. | https://github.com/0xMacro/awesome-solana-security | 595 | 2 | Last commit (Dec 06, 2025) | SDKs & Tooling |
...
| Pump.fun-Smart-Contract | This is a forked version of Pump.fun smart contract (Solana Pumpfun Smart Contract fork, Pumpfun smart contract development Tool, Pumpfun smart contract SDK) | https://github.com/justshiftjk/Pump.fun-Smart-Contract | 106 | 1 | Last commit (Oct 20, 2025) | SDKs & Tooling |
...
| metaboss | The Metaplex NFT-standard Swiss Army Knife tool. | https://github.com/samuelvanderwaal/metaboss | 717 | 26 | v0.47.0 (Mar 24, 2026) | NFTs & Programs |
