...
| solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 849 | 28 | Last commit (Sep 27, 2025) | SDKs & Tooling |
...
| NEW StablePay | Enterprise-grade stablecoin payment processor built on Solana that leverages Perena's stablecoin infrastructure. | https://github.com/FarseenSh/StablePay | 7 | 2 | Last commit (May 27, 2025) | Payments |
