...
| kit | Solana JavaScript SDK | https://github.com/anza-xyz/kit | 684 | 165 | v6.9.0 (May 06, 2026) | SDKs & Tooling |
...
| solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 938 | 32 | Last commit (May 21, 2026) | SDKs & Tooling |
...
| quasar | A blazing fast Solana program framework. | https://github.com/blueshift-gg/quasar | 154 | 18 | Last commit (May 18, 2026) | SDKs & Tooling |
| Pumpfun-Solana-Smart-Contract | pump.fun clone: pumpfun smart contract fork (pump.fun fork), solana pump fun smart contract source code | https://github.com/cutupdev/Pumpfun-Solana-Smart-Contract | 313 | 1 | Last commit (Dec 21, 2025) | SDKs & Tooling |
...
| cryptocurrency.cv | Free crypto news API - real-time aggregator for Bitcoin, Ethereum, DeFi, Solana & altcoins. No API key required. RSS/Atom feeds, JSON REST API, historical archive with market context, embeddable widgets, ChatGPT plugin, Claude MCP server, SDKs (Python, TypeScript, Go, React, PHP). AI/LLM ready. Vibe coding friendly. Open source. | https://github.com/nirholas/cryptocurrency.cv | 212 | 10 | Last commit (May 13, 2026) | DeFi |
...
| teller-solana-dapp | Solana wallet analytics and chain stats dApp adapted for Solana Mobile and dApp Store | https://github.com/NadirAliOfficial/teller-solana-dapp | 6 | 1 | v2026.05.21 (May 21, 2026) | DeFi |
