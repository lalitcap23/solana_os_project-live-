...
| solana-poc-framework | A framework for creating PoC's for Solana Smart Contracts in a painless and intuitive way | https://github.com/neodyme-labs/solana-poc-framework | 242 | — | Last commit (Oct 07, 2025) | SDKs & Tooling |
...
| solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 900 | 28 | Last commit (Dec 13, 2025) | SDKs & Tooling |
...
| Mobile Wallet Adapter | Protocol for connecting apps to mobile wallets | https://github.com/solana-mobile/mobile-wallet-adapter | 309 | 19 | Active | Wallets & Mobile |
| Seed Vault SDK | Secure key custody API/service for Android | https://github.com/solana-mobile/seed-vault-sdk | 89 | — | v0.4.0 (Oct 06, 2025) | Wallets & Mobile |
...
| SPL Libraries (new org) | Helper libraries/building blocks for on-chain programs | https://github.com/solana-program/libraries | — | — | Active | Programs (SPL) |
