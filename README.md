...
| kit | Solana JavaScript SDK | https://github.com/anza-xyz/kit | 662 | 158 | v6.1.0 (Feb 16, 2026) | SDKs & Tooling |
...
| Solana-Prediction-Market | Solana Prediction Market where users can create market, add liquidity, and bet | https://github.com/HyperBuildX/Solana-Prediction-Market | 337 | 1 | Last commit (Feb 24, 2026) | SDKs & Tooling |
...
| solana-playground | Quickly develop, deploy and test Solana programs from browsers | https://github.com/solana-playground/solana-playground | 919 | 31 | Last commit (Feb 23, 2026) | SDKs & Tooling |
...
| radar | A static analysis tool for anchor rust programs. | https://github.com/Auditware/radar | 129 | 5 | Last commit (Feb 21, 2026) | SDKs & Tooling |
...
| SPL Libraries (new org) | Helper libraries/building blocks for on-chain programs | https://github.com/solana-program/libraries | 14 | 21 | pod@v0.8.0 (Feb 23, 2026) | Programs (SPL) |
